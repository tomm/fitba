...
class ActiveRecord::MismatchedForeignKey < ActiveRecord::StatementInvalid
  def column_type(table, column); end
  def initialize(adapter = nil, message: nil, table: nil, foreign_key: nil, target_table: nil, primary_key: nil); end
end
...
module ActiveRecord::ConnectionAdapters::PostgreSQL::SchemaStatements
  ...
  def change_column_sql(table_name, column_name, type, options = nil); end
  def change_table_comment(table_name, comment); end
...
class ActiveRecord::ConnectionAdapters::PostgreSQLTypeMetadata < Anonymous_Delegator_16
  def ==(other); end
  def array; end
  def attributes_for_hash; end
  def eql?(other); end
